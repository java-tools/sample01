...
pkgs=(git vim-enhanced openqa openqa-httpd openqa-worker fedora-messaging guestfs-tools libguestfs-xfs python3-fedfind python3-libguestfs python3-pip libvirt-daemon-config-network virt-install withlock postgresql-server perl-REST-Client)
...
[global]
branding=plain
download_domains = almalinux.org fedoraproject.org opensuse.org
...
echo ""
echo "If you want to do a similar setup but for AlmaLinux then run..."
echo ""
echo "    ./install-openqa-post-almalinux.sh"
echo ""
